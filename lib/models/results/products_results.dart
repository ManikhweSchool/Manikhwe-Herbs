class ProductResultLanguage{
  ...
  static const imiphumelaVulidlozi = 
  ['Kuvuleka Udlozi Umakade Livalekile. Ngokwenza Loku Kuqaqeka Izinto Zakho Ngoba Idlozi Lisuke Selithokozile.',
  ];

   static const imiphumelaBelungubami = 
  ['Abaphathi Bakho Emsebenzi Bayakukhonza, Bakuhloniphe, Babenomusa Omkhulu Kuwe, Ungathola Nesikhundla.',
  ];
  ...
  static const imiphumelaBolisa = ['Uyabolisa Okubi Okwenziwe Noma Okwenziwa Kuwe.',];
   ...
   static const imiphumelaOshimileXXX = ['Baziletha Bona Abesifazane Kuwe.',];
  ...
  static const imiphumelaLahlokubiXXX = 
  [
    'Ulungele Umuntu Othathwa Kancane Abanye Abantu.',
  ];

  static const imiphumelaBohlasisu = 
  [
    'Umangabe Ukhukhunyalelwa Isisu Lomuthi Uyasibohlisa.',
  ];

  static const imiphumelaIsibungeXXX = 
  [
    'Sikhanda Isiphithiphithi Sabathengi.',
  ];
  ...
  static const imiphumelaMaqaqabebophile = 
  [
    'Kuqaqeka Izinto Zakho Noma Bekuthakathile.',
  ];

  static const imiphumelaAzwewenefonini = 
  [
    'Uzwangawe Efonini',
  ];

  static const imiphumelaWebeleni = 
  [
    'Buyisa Okwebiwe',
  ];
  ...
  [
    'Umakwenzekile Isithandwe Sakho Salala Nomunye Umuntu, Babambana Njenge Zinja Uma Zenza Ucansi.',
  ];

  static const imiphumelaOwenhlanhlaXXX = 
  [
    'Uletha Inhlanhla',
  ];

  static const imiphumelaVukanduku = 
  [
    'Uvusa Ipipi Umangabe Ungasaqhanyelwa.',
  ];

  static const imiphumelaBohlasisuXXX = 
  [
    'Uma Ukhukhunyalelwa Isisu Siyehla.',
  ];

  static const imiphumelaKufogadlayo = 
  [
    'Okuthakathayo Uyafa',
  ];

  static const imiphumelaQaqabethakathile = 
  [
    'Izinto Zakho Ziqaqeka Noma Bekuthakathile.',
  ];

  static const imiphumelaQedanduna = 
  [
    'Izinduna Ziphelanya Ebusweni Bakho.',
  ];
  ...
  static const imiphumelaTholamawele =
  ['Umitha Noma Umuthisa Amawele',
  ];
  ...
  static const imiphumelaGezamabhadi = 
  [
    'Ugeza Amabhadi.',
  ];
  ...
  static const imiphumelaOzalwembethe = 
  [
    'Umawazalwa Umbethe Kubuya Inhlanhla Yakho.',
  ];
}