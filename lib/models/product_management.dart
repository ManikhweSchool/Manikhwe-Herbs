...
class Mndenongaxabani extends Umuthi{
  ...
  languageIndex){
    ...
    izilwane.add('Buffalo/Nyathi Oil');
...
// ****************The variable 'izilwane' is no longer in use all products that are below****************
