class HowToUseLanguage{
  ...
  static const howToUseNyokaEswini =
  [
    'Pheka Lomuthi Uwuphuze Kabili Ngosuku.'
  ];
  ...
  [
    'Gezela Ngaphandle Kwegceke.',
  ];

  static const howToUseBohlasisu =
  [
    'Uwubilisa Isikhathi Eside Lomuthi, Bese Uyawupholisa. Usungaphuza Ekuseni Nantambama.'
  ];

  static const howToUseIsbungeXXX = 
  [
    'Uyashiswa',
  ];
  ...
  static const howToUseQedanduna = 
  [
    'Gquma, Phalaza Izinsuku Ezingu-7 Kulandela.',
  ];
  ...
  static const howToUseOzalwembethe = 
  [
    'Ugquma, Uphalaze, Ube Ukhanyise Amakhandlela Amane(White, Red, Yellow & Blue). '
    'Uma Usuqedile Ukuphalaza Noma Ukugquma Uyawacisha Amakhandle. Uyophinde Uwakhanyise '
    'Uma Usugquma Noma Usuphalaza Futhi. Ukwenza Izinsuku Ezintathu Kulandelana. Ngosuku '
    'Lokugcina Ungawacishi Amakhandlela Aziphelele.',
  ];
  
  

  static const howToUseAzwewenefonini = 
  [
    'Lomuthi Uwufaka Ngaphansi Kolwimi, Bese Uyamfonela Lowomuntu Ofuna Azwe Ngawe Efonini.',
  ];

  

  static const howToUseWebeleni = 
  [
    'shisa nempetho lakuthathwe khona, usebenzisa ngommbese noma ukha imithi',
  ];
  ...
  static const howToUseBabambanokwezinja = 
  [
    'Ithenga U-Okapi(Ummese) Omusha, Udinga Nethawula Enisula Ngalo Umakade Nenza Ucansi Nowakwakho, '
    'Umchamo Womuntu Wakho, '
    'Insila Yepipi Lenja Nomchamo Wayo, Insila Yengquza Yenza Nomchamo Wayo, '
    'Thatha Leli Thawula Lenu Enisula Ngalo, Sula Izinja Uma Sezikhingqelene, '
    'Gaya Lemithi, Uyikhamele Kuleziyansila Zenu , Hlaliza Lezinsila Zenu Laphaya Kanye Ne-Okapi'
    'Uma Kuyawena Ukuyolala Nomuntu Wakho Uyivule I-Okati, Mese Uqedile Uyoyivala',
  ];

  

  static const howToUseVukanduku = 
  [
    'Hlanganisa Lomuthi Nobisi I-Long Life, Kubilise Ndawonye Imizuzu Eyisihlanu Kuya Kweyishumi. Umasekupholile Uphuze Kabili Ngosuku.',
  ];

  
  static const howToUseKufogadlayo = 
  [
    'Gcaba Onke Amalunga Omzimba',
  ];
  ...
  static const howToUseMzimboshisayo =
